...
public class Pergunta7 extends Activity {
    ...
    public void Proxima7(View v){
        Intent it7 = new Intent(Pergunta7.this,Pergunta8.class);
        it7.putExtra("nome",nome);
        it7.putExtra("pontos",pontos);
        if(respondido == false){
            Toast.makeText(this, "Escolha uma alternativa!", Toast.LENGTH_SHORT).show();
        }else{
            startActivity(it7);
