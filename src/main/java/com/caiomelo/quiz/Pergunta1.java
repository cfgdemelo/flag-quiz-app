...
public class Pergunta1 extends Activity {
    ...
    public void Proxima1(View v){
        Intent it1 = new Intent(Pergunta1.this,Pergunta2.class);
        it1.putExtra("nome",nome);
        it1.putExtra("pontos", pontos);
        if(respondido == false){
            Toast.makeText(this, "Escolha uma alternativa!", Toast.LENGTH_SHORT).show();
        }else{
            startActivity(it1);
