...
public class Pergunta9 extends Activity {
    ...
    public void Proxima9(View v){
        Intent it9 = new Intent(Pergunta9.this,Pergunta10.class);
        it9.putExtra("nome",nome);
        it9.putExtra("pontos",pontos);
        if(respondido == false){
            Toast.makeText(this, "Escolha uma alternativa!", Toast.LENGTH_SHORT).show();
        }else{
            startActivity(it9);
