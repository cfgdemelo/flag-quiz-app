...
public class Pergunta8 extends Activity {
    ...
    public void Proxima8(View v){
        Intent it8 = new Intent(Pergunta8.this,Pergunta9.class);
        it8.putExtra("nome",nome);
        it8.putExtra("pontos",pontos);
        if(respondido == false){
            Toast.makeText(this, "Escolha uma alternativa!", Toast.LENGTH_SHORT).show();
        }else{
            startActivity(it8);
